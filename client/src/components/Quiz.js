...
var Quiz = function () {
    ...
    if (!quizStarted) {
        return (React.createElement("div", { className: "p-4 text-center" },
            React.createElement("button", { className: "btn btn-primary d-inline-block mx-auto", onClick: handleStartQuiz }, "Start Quiz")));
    }
    if (quizCompleted) {
        return (React.createElement("div", { className: "card p-4 text-center" },
            React.createElement("h2", null, "Quiz Completed"),
            React.createElement("div", { className: "alert alert-success" },
                "Your score: ",
                score,
                "/",
                questions.length),
            React.createElement("button", { className: "btn btn-primary d-inline-block mx-auto", onClick: handleStartQuiz }, "Take New Quiz")));
    }
    ...
    return (React.createElement("div", { className: 'card p-4' },
        React.createElement("h2", null, currentQuestion.question),
        React.createElement("div", { className: "mt-3" }, currentQuestion.answers.map(function (answer, index) { return (React.createElement("div", { key: index, className: "d-flex align-items-center mb-2" },
            React.createElement("button", { className: "btn btn-primary", onClick: function () { return handleAnswerClick(answer.isCorrect); } }, index + 1),
            React.createElement("div", { className: "alert alert-secondary mb-0 ms-2 flex-grow-1" }, answer.text))); }))));
};
export default Quiz;
